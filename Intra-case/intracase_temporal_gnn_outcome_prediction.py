# -*- coding: utf-8 -*-
"""Intracase Temporal GNN Outcome Prediction.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1W2gGLuwGIhOYL45HpFucQTa4bv2DaCLR
...
with open("/content/drive/MyDrive/Preprocessed Logs for Intra-case/Hospital billing/Hospital billing 2/hospital_billing_2_temporal_train_with_all_seed=0.txt", "rb") as fp:   # Unpickling
  train_dataset = pickle.load(fp)

with open("/content/drive/MyDrive/Preprocessed Logs for Intra-case/Hospital billing/Hospital billing 2/hospital_billing_2_temporal_validation_with_all_seed=0.txt", "rb") as fp:   # Unpickling
  val_dataset = pickle.load(fp)

with open("/content/drive/MyDrive/Preprocessed Logs for Intra-case/Hospital billing/Hospital billing 2/hospital_billing_2_temporal_test_with_all_seed=0.txt", "rb") as fp:   # Unpickling
  test_dataset = pickle.load(fp)

print(len(train_dataset.processes), len(val_dataset.processes), len(test_dataset.processes))

print(train_dataset.eventAttributeNames)

train_dataset.processes[0].processAttributeVector
...
print(int(train_dataset.numEventAttributes/2), int(train_dataset.numEventAttributes/10), train_dataset.numActivities, train_dataset.numEventAttributes, train_dataset.numProcessAttributes)
...
# %%time
# train_model(model, optimizer, loss_func, 200, 40, "/content/drive/MyDrive/Temporal GNN/BPIC 2011/Ordered/2011_2_with_all_seed=0_summed_updated_loss_arch3.pt", train_dataset, val_dataset)
...
model.load_state_dict(torch.load("/content/drive/MyDrive/Temporal GNN/BPIC 2011/Ordered/2011_2_with_all_seed=0_summed_updated_loss_arch3.pt"))

print("Training set results\n")
evaluate(model,train_dataset,loss_func, 40)
print("---------------------")
print("Validation set results\n")
evaluate(model,val_dataset,loss_func, 40)
print("---------------------")
print("Test set results\n")
evaluate(model,test_dataset,loss_func, 40)

prefixLengths = []
AUCs = []

for i in range(1, 36):
    loss, AUC = evaluate(model,test_dataset,loss_func,36, i)
