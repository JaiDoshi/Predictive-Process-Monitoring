...
#Read dataframe
df = pd.read_csv("/content/drive/My Drive/Process Modelling Datasets/sepsis_cases_1.csv", sep=';')
...
processAttributeNames = ['Age']

one_hot = pd.get_dummies(df['Diagnose'])

df = df.drop('Diagnose',axis = 1)
one_hot = one_hot.add_suffix('_r1')
processAttributeNames += list(one_hot.columns)
df = df.join(one_hot)

one_hot = pd.get_dummies(df['DiagnosticArtAstrup'])

df = df.drop('DiagnosticArtAstrup',axis = 1)
one_hot = one_hot.add_suffix('_r2')
df = df.join(one_hot)

one_hot = pd.get_dummies(df['DiagnosticBlood'])

df = df.drop('DiagnosticBlood',axis = 1)
one_hot = one_hot.add_suffix('_r3')
df = df.join(one_hot)

one_hot = pd.get_dummies(df['DiagnosticECG'])

df = df.drop('DiagnosticECG',axis = 1)
one_hot = one_hot.add_suffix('_r4')
df = df.join(one_hot)

one_hot = pd.get_dummies(df['DiagnosticIC'])

df = df.drop('DiagnosticIC',axis = 1)
one_hot = one_hot.add_suffix('_r5')
df = df.join(one_hot)

one_hot = pd.get_dummies(df['DiagnosticLacticAcid'])

df = df.drop('DiagnosticLacticAcid',axis = 1)
one_hot = one_hot.add_suffix('_r6')
df = df.join(one_hot)

one_hot = pd.get_dummies(df['DiagnosticLiquor'])

df = df.drop('DiagnosticLiquor',axis = 1)
one_hot = one_hot.add_suffix('_r7')
df = df.join(one_hot)

one_hot = pd.get_dummies(df['DiagnosticOther'])

df = df.drop('DiagnosticOther',axis = 1)
one_hot = one_hot.add_suffix('_r8')
df = df.join(one_hot)

one_hot = pd.get_dummies(df['DiagnosticSputum'])

df = df.drop('DiagnosticSputum',axis = 1)
one_hot = one_hot.add_suffix('_r9')
df = df.join(one_hot)

one_hot = pd.get_dummies(df['DiagnosticUrinaryCulture'])

df = df.drop('DiagnosticUrinaryCulture',axis = 1)
one_hot = one_hot.add_suffix('_r10')
df = df.join(one_hot)

one_hot = pd.get_dummies(df['DiagnosticUrinarySediment'])

df = df.drop('DiagnosticUrinarySediment',axis = 1)
one_hot = one_hot.add_suffix('_r11')
df = df.join(one_hot)

one_hot = pd.get_dummies(df['DiagnosticXthorax'])

df = df.drop('DiagnosticXthorax',axis = 1)
one_hot = one_hot.add_suffix('_r12')
df = df.join(one_hot)

one_hot = pd.get_dummies(df['DisfuncOrg'])

df = df.drop('DisfuncOrg',axis = 1)
one_hot = one_hot.add_suffix('_r13')
df = df.join(one_hot)

one_hot = pd.get_dummies(df['Hypotensie'])

df = df.drop('Hypotensie',axis = 1)
one_hot = one_hot.add_suffix('_r14')
df = df.join(one_hot)

one_hot = pd.get_dummies(df['Hypoxie'])

df = df.drop('Hypoxie',axis = 1)
one_hot = one_hot.add_suffix('_r15')
df = df.join(one_hot)

one_hot = pd.get_dummies(df['InfectionSuspected'])

df = df.drop('InfectionSuspected',axis = 1)
one_hot = one_hot.add_suffix('_r16')
df = df.join(one_hot)

one_hot = pd.get_dummies(df['Infusion'])

df = df.drop('Infusion',axis = 1)
one_hot = one_hot.add_suffix('_r17')
df = df.join(one_hot)

one_hot = pd.get_dummies(df['Oligurie'])

df = df.drop('Oligurie',axis = 1)
one_hot = one_hot.add_suffix('_r18')
df = df.join(one_hot)

one_hot = pd.get_dummies(df['SIRSCritHeartRate'])

df = df.drop('SIRSCritHeartRate',axis = 1)
one_hot = one_hot.add_suffix('_r19')
df = df.join(one_hot)

one_hot = pd.get_dummies(df['SIRSCritLeucos'])

df = df.drop('SIRSCritLeucos',axis = 1)
one_hot = one_hot.add_suffix('_r20')
df = df.join(one_hot)

one_hot = pd.get_dummies(df['SIRSCritTachypnea'])

df = df.drop('SIRSCritTachypnea',axis = 1)
one_hot = one_hot.add_suffix('_r21')
df = df.join(one_hot)

one_hot = pd.get_dummies(df['SIRSCritTemperature'])

df = df.drop('SIRSCritTemperature',axis = 1)
one_hot = one_hot.add_suffix('_r22')
df = df.join(one_hot)

one_hot = pd.get_dummies(df['SIRSCriteria2OrMore'])

df = df.drop('SIRSCriteria2OrMore',axis = 1)
one_hot = one_hot.add_suffix('_r23')
df = df.join(one_hot)

one_hot = pd.get_dummies(df['org:group'])

df = df.drop('org:group',axis = 1)
one_hot = one_hot.add_suffix('_r24')
df = df.join(one_hot)

one_hot = pd.get_dummies(df['month'])

df = df.drop('month',axis = 1)
one_hot = one_hot.add_suffix('_r25')
df = df.join(one_hot)

one_hot = pd.get_dummies(df['weekday'])

df = df.drop('weekday',axis = 1)
one_hot = one_hot.add_suffix('_r26')
df = df.join(one_hot)
...
for column in df:
    if column == 'timesincelastevent' or column == 'timesincecasestart' or column == 'timesincemidnight' or column == 'event_nr' or column == 'open_cases' or column == 'Age' or column == 'CRP' or column == 'LacticAcid' or column == 'Leucocytes':
        mex = df[column].max()
        mine = df[column].min()
        df[column] -= mine
        df[column]/=(mex-mine)
