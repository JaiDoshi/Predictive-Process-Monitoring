# -*- coding: utf-8 -*-
"""BPIC 2015 Temporal GNN Inter-case.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/14198UyZmDgqhw4oBse0LAkPUyIcSSgl-

<a href="https://colab.research.google.com/github/JaiDoshi/Explainabale-Predictive-Process-Monitoring/blob/main/Temporal_GNN.ipynb" target="_parent"><img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab"/></a>
"""
...
print(len(train_case_ids), len(validation_case_ids), len(test_case_ids))
...
print(eventAttributeNames, numEventAttributes)

numProcessAttributes = len(processAttributeNames)
print(processAttributeNames, numProcessAttributes)
